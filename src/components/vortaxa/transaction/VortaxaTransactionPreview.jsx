  ...
  if (recentTransactions.length === 0) {
    return (
      <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
        ...
        <div className="flex min-h-[120px] items-center justify-center rounded-xl border border-dashed border-slate-700 bg-slate-950">
      ...
      <div className="space-y-2">
        ...
        {recentTransactions.map((transaction) => {
          ...
          return (
            <div
              key={transaction?.id}
              className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-950/50 px-3 py-3"
            >
